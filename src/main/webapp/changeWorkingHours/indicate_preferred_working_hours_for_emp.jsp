...
<html>
<head>
    <title>Предпочтительное время работы сотрудника</title>
    <style>
        .style {
            text-align: center;
...
<body>
<div class="style">
    <h1>Предпочтительное время работы сотрудника</h1>
    <hr/>
    <hr/>
    <form method="get">
        <input type="hidden" name="actionName" value="change-preferred-working-hours-for-emp">
        <label for="employeeID">ID сотрудника </label>
        <input class="style" id="employeeID" type="number" name="employeeID">
        <br/>

        <label for="working-hours">Желаемое время работы</label>
