...
<html>
<head>
    <title>Предпочтительное время работы департамента</title>
    <style>
        .style {
            text-align: center;
...
<body>
<div class="style">
    <h1>Предпочтительное время работы департамента</h1>
    <hr/>
    <hr/>
    <form method="get">
        <input type="hidden" name="actionName" value="change-preferred-working-hours-for-dep">
