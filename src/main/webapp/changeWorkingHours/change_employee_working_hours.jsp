...
<html>
<head>
    <title>Изменить время работы сотрудника</title>
    <style>
        .style {
            text-align: center;
...
<body>
<div class="style">
    <h1>Изменить действующее рабочее время сотрудника</h1>
    <hr/>
    <hr/>
    <form method="get">
        <input type="hidden" name="actionName" value="change-current-working-hours-for-emp">
